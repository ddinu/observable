...
TEST_CASE("documentation examples/getting started", "[documentation examples]")
{
    provide_cin cin_buf { "Jane"s };
    capture_cout cout_buf;

    SECTION("getting started with subjects")
    {
        // BEGIN EXAMPLE CODE
        using namespace std;
        ...
        REQUIRE("What's your name?\nHello Jane!\nWhat's your name?\n"s ==
                cout_buf.str());
    }

    SECTION("getting started with values")
    {
        // BEGIN EXAMPLE CODE
        using namespace std;
        using namespace observable;
    ...
    SECTION("getting started with properties")
    {
        // BEGIN EXAMPLE CODE
        using namespace std;
        using namespace observable;
