...
inline auto time_run(Function && function, unsigned long const repeat_count = 1'000'000)
{
...
inline auto slowdown(std::chrono::nanoseconds fast, std::chrono::nanoseconds slow)
{
...
//! Print timings.
inline auto print(std::string first_name, std::chrono::nanoseconds first_duration,
